...
var OutputPins = {
    channel0: 38,    // header 38 - GPIO20
    channel1: 37,    // header 37 - GPIO26
    channel2: 40,    // header 40 - GPIO21
    voltage0: 31,    // header 31  - GPIO6
    voltage1: 32,    // header 32  - GPIO12
    disable: 36,     // header 36  - GPIO16   (8 and 9 have internal pull-up resistors, use 15, 16 if that causes a problem)
    reset: 13        // header 13  - GPIO27
};
...
var exports = {
    ...
    SetCircuit: function (currentChannel, voltageChannel) {
